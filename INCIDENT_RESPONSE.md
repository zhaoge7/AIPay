...
| `paid` with delivery pending                | Continue proof-bound fulfillment with the stored result and confirm delivery; do not charge again                                                                            | Re-consuming proof for a different resource or starting another payment                 |
